...
def index():
    ...
    return render_template('index.jinja2', form=form, posts=posts,
...
def edit_profile_admin(id):
    ...
    return render_template('edit_profile.jinja2', form=form, user=user)
...
def post(id):
    ...
    return render_template('post.jinja2', posts=[post], form=form,
...
def followers(username):
    ...
    return render_template('followers.jinja2', user=user, title="Followers of",
...
def followed_by(username):
    ...
    follows = [{'user': item.followed, 'timestamp': item.timestamp}
               for item in pagination.items]
    return render_template('followers.jinja2', user=user, title="Followed by",
...
def moderate():
    ...
    pagination = Comment.query.order_by(Comment.timestamp.desc()).paginate(
        ...
        error_out=False)
    comments = pagination.items
    return render_template('moderate.jinja2', comments=comments,
